...
import {apiNash_messageList} from './lookup'

import {Nash_message} from './detail'

export function Nash-messageList(props) {
    ...
    useEffect(() => {
      if (nash-messageDidSet === false){
        ...
        apiNash_messageList(props.username, handleNash_messageListLookup)
      }
    ...
    const handleLoadNext = (event) => {
      ...
      if (nextUrl !== null) {
        ...
        apiNash_messageList(props.username, handleLoadNextResponse, nextUrl)
      }
    }
